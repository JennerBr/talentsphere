...
// Mock data para tipos de log
export const MOCK_LOG_TYPES = [
  { id: 1, name: "Feedback Positivo", color: "green", description: "Reconhecimento por um bom trabalho ou atitude." },
  { id: 2, name: "Ponto de Atenção", color: "amber", description: "Algo que precisa ser melhorado ou observado." },
  { id: 3, name: "Alinhamento de Meta", color: "blue", description: "Discussão sobre objetivos e resultados chave (OKRs)." },
  { id: 4, name: "Plano de Carreira", color: "purple", description: "Conversa sobre desenvolvimento profissional e PDI." },
  { id: 5, name: "Acompanhamento (Follow-up)", color: "slate", description: "Checagem de rotina de uma tarefa ou projeto." },
];

export default function AdminLogTypes() {
  const [selectedColor, setSelectedColor] = useState("blue");
  const [logTypes, setLogTypes] = useState(MOCK_LOG_TYPES);
