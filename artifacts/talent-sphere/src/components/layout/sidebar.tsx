...
export function Sidebar({ role, className, onNavigate }: SidebarProps) {
  ...
  const adminLinks = [
    { href: "/admin/organizacoes", label: "Teams", icon: Building2 },
  ...
  return (
    <div className={cn("flex flex-col w-64 border-r bg-card h-full shrink-0", className)}>
      ...
      <div className="p-4 border-t">
        <button
          type="button"
          className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-muted-foreground hover:text-destructive transition-colors w-full"
